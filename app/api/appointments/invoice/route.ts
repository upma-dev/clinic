...
export async function GET(req: NextRequest) {
  try {
    ...
    const isCash = String(booking.paymentMethod || '').toLowerCase() === 'cash';
...
<body>
  ...
  <div class="button-container">
    ...
    <a href="/users" class="print-btn" style="background:#4b5563;">Back to Portal</a>
  </div>
  ...
  <div class="invoice-card">
    ...
    <div class="meta-grid" style="margin-top: -15px; background: #f8fafc; padding: 15px; border-radius: 12px; border: 1px solid #e2e8f0;">
      ...
      <div class="meta-box" style="margin-bottom: 0;">
        ...
        <p>Mode: <span>Direct Cash Collection</span></p>
      </div>
      ` : `
      <div class="meta-box" style="margin-bottom: 0;">
